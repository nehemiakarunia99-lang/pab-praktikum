...
private val dummyCourses = listOf(
    Course("Pemrograman Aplikasi Bergerak", "IF-4201", 42),
    Course("Rekayasa Perangkat Lunak", "IF-4105", 38),
    Course("Kecerdasan Buatan", "IF-4310", 45),
)

/**
 * HomeScreen - fitur daftar mata kuliah (Course List) SCAS
 * Sesuai source code asli: welcome header + list course + FAB tambah course
 * Komponen: Scaffold, TopAppBar, LazyColumn, Card, FloatingActionButton
 */
